"""
These are views for the Oxfordshire South events app.
...
def upcoming_events(request):
    ...
    return render(
        request,
        "events/oxfordshire/south/upcoming_events.html",
        {
            "events": events,
            "now": now,
        },
...
def event_detail(request, slug: str):
    ...
    return render(
        request,
        "events/oxfordshire/south/event_detail.html",
        {
            "event": event,
            "now": timezone.now(),
        },
...
def venue_list(request):
    ...
    return render(
        request,
        "events/oxfordshire/south/venue_list.html",
        {
            "venues": venues,
        },
    )
...
def venue_detail(request, pk: int):
    ...
    return render(
        request,
        "events/oxfordshire/south/venue_detail.html",
        {
            "venue": venue,
...
def category_events(request, category: str):
    ...
    return render(
        request,
        "events/oxfordshire/south/category_events.html",
        {
            "events": events,
            "category": category,
            "now": now,
...
def past_events(request):
    ...
    return render(
        request,
        "events/oxfordshire/south/past_events.html",
        {
            "events": events,
            "now": now,
        },
