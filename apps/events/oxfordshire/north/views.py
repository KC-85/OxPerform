"""
These are views for the Oxfordshire North events app.
...
def upcoming_events(request):
    ...
    return render(
        request,
        "events/oxfordshire/north/upcoming_events.html",
        {
            "events": events,
            "now": now,
        },
...
def event_detail(request, slug: str):
    ...
    return render(
        request,
        "events/oxfordshire/north/event_detail.html",
        {
            "event": event,
            "now": timezone.now(),
        },
...
def venue_list(request):
    ...
    return render(
        request,
        "events/oxfordshire/north/venue_list.html",
        {
            "venues": venues,
        },
    )
...
def venue_detail(request, pk: int):
    ...
    return render(
        request,
        "events/oxfordshire/north/venue_detail.html",
        {
            "venue": venue,
...
def category_events(request, category: str):
    ...
    return render(
        request,
        "events/oxfordshire/north/category_events.html",
        {
            "events": events,
            "category": category,
            "now": now,
...
def past_events(request):
    ...
    return render(
        request,
        "events/oxfordshire/north/past_events.html",
        {
            "events": events,
            "now": now,
        },
